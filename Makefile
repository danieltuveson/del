...
# Debug flags:
# - For specific features: DEBUG_LEXER, DEBUG_PARSER, DEBUG_TYPECHECKER, DEBUG_COMPILER,
#                          DEBUG_RUNTIME
# - For one-off things that I don't want to run in "prod" and will probably delete: DEBUG
# - To enable everything: DEBUG_ALL
CFLAGS = -O2 -g -Wall -Wextra -DGCOFF=0 -DTHREADED_CODE_ENABLED=1 -DDEBUG_COMPILER=1
