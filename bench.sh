...
# sudo chrt -f 99 perf stat -ddd ./del benchmark/benchmark_while.del
...
# sudo chrt -f 99 perf stat -ddd python3 benchmark/benchmark_while.py
# 
# # lua
sudo chrt -f 99 perf stat -ddd lua benchmark/benchmark.lua
# sudo chrt -f 99 perf stat -ddd lua benchmark/benchmark_heap.lua
# sudo chrt -f 99 perf stat -ddd lua benchmark/benchmark_while.lua
# 
...
# sudo chrt -f 99 perf stat -ddd luajit -joff benchmark/benchmark_while.lua

# ghc -O2 benchmark/benchmark.hs
